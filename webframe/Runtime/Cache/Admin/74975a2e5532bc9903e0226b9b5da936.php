...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/html/webframework/webframe/index.php/Admin/News/ajaxIndex",
					//cache: false,
		...
		*/		
		function add(){
			var index = layer.open({
						...
						content: ['/html/webframework/webframe/index.php/Admin/News/add', 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(news_name==""||news_time==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/html/webframework/webframe/index.php/Admin/News/insert',
									data: obj.serialize(),
									cache: false,
