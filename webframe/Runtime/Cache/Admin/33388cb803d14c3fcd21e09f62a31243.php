...
<html>
    ...
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
            <tr height=28>
                <td background=<?php echo ($smarty["const"]["ADMIN_IMG_URL"]); ?>title_bg1.jpg>当前位置: </td></tr>
            <tr>
        ...
        <table cellspacing=0 cellpadding=0 width="90%" align=center border=0>
            <tr height=100>
                <td align=middle width=100><img height=100 src="<?php echo ($smarty["const"]["ADMIN_IMG_URL"]); ?>admin_p.gif" 
                                                width=90></td>
                <td width=60>&nbsp;</td>
                <td>
