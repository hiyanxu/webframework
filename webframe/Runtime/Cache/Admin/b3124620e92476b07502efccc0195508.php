			...
			<div >
				<ul class="nav navbar-nav">
						...
						<a style="background-color:#62A8D1;" class="dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<li>
								<a href="#"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;FrontPage</a>
							</li>
							...
							<li style="margin-top:-20px;">
								<a  href="#"><span class="glyphicon glyphicon-off" aria-hidden="true"></span>&nbsp;Logout</a>
                                        ...
                                        <li><a id="aLogout" style="color:white; margin-top: 5px;" href="/webframework/webframe/index.php/Admin/Index/logout"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Logout</a></li>
				</ul>                                
			</div>
		</nav>
	</body>
